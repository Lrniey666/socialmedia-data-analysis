...
Language: [繁體中文](../CONTRIBUTING.md) · [English](CONTRIBUTING.en.md)
...
1. Read [`../README.md`](../README.md) and [`analysis.en.md`](analysis.en.md).
...
| Item | Rule |
| --- | --- |
| Public docs | Traditional Chinese in `README.md`; English in `docs/README.en.md`. Edit both. |
| Dates | `YYYY-MM-DD`, Taipei time |
| Changelog | `CHANGELOG.md` → `## [Unreleased]` (Keep a Changelog 2.0.0) |
| Line endings | LF (`.gitattributes`) |
| English | English (licence, analysed, behaviour) |
...
3. Holiday definition changes → update [`analysis.md`](analysis.md) and [`analysis.en.md`](analysis.en.md)
