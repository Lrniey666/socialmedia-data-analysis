"""Fetch public upload metadata via the YouTube Data API v3.

Copy config.example/youtube.json to secrets/youtube.json and put your key there.
"""
...
api_version = "v3"
api_key_file = ROOT / "secrets" / "youtube.json"
save_csv_path = ROOT / "data" / "YouTube" / "video_details.csv"
